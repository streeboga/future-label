# Future Label — Project Root

## Project Overview

Music label management platform. Laravel 13 API backend + React SPA frontend.

- **Backend**: Laravel 13 / PHP 8.4 / PostgreSQL (`future_label`)
- **Frontend**: React 19 / TypeScript / Vite / TanStack / ShadCN (Framer theme)
- **Auth**: Laravel Sanctum, Bearer Token
- **API**: JSON:API v1.1, versioned under `/api/v1/`
- **Tests**: Pest v4, coverage >= 85%

## Directory Index

| Directory | Description |
|-----------|-------------|
| [`app/`](app/CLAUDE.md) | Laravel backend — controllers, services, models, repos |
| [`frontend/`](frontend/CLAUDE.md) | React SPA — TanStack Router/Query, ShadCN UI |
| [`database/`](database/CLAUDE.md) | Migrations, factories, seeders |
| [`tests/`](tests/CLAUDE.md) | Pest test suite |
| [`docs/`](docs/CLAUDE.md) | Plans, API docs, BMAD artifacts |
...
- `.env` — DB: PostgreSQL `future_label`, Queue: Redis, Cache: Redis
- `.mcp.json` — MCP: Playwright, Chrome DevTools
- `_bmad/` — BMAD Method v6.2.2 (43 skills)
